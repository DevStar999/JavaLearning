...
public class Date_Inbuilt {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("The given date is after date d4 : " + d4.after( new java.util.Date(year-1900,month-1,date-56) )) ;
		
		// (2).before()-Tests if object date is before the given date(i.e.for this ex.,is d4 before arg. date or not).
		System.out.println("The given date is before date d4 : " + d4.before( new java.util.Date(year-1900,month-1,date-56) )) ;
